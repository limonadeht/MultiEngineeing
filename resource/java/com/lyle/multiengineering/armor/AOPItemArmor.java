package com.lyle.multiengineering.armor;

import net.minecraft.entity.Entity;
import net.minecraft.item.ItemArmor;
import net.minecraft.item.ItemStack;

public class AOPItemArmor extends ItemArmor
{
	//private String armorTexturePath = "multiengineeing:";
	private String iconTexturePath = "multiengineeing:/";

	public AOPItemArmor(ArmorMaterial armorMaterial,int par3,int par4,String type)
	{
